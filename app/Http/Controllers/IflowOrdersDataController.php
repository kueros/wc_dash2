	...
	public function index()
	{
		...
		/* $data =
			IflowOrderData::select(
				'iflow_woo_order_data.id',
				'iflow_woo_order_data.order_id',
				'iflow_woo_order_data.tracking_id',
				'iflow_woo_order_data.shipment_id',
				'iflow_woo_order_data.print_url',
				'iflow_woo_order_data.code',
				'woo_order.order_nro',
				'woo_order.store',
				'woo_order.index_id',
				'woo_order.app_id',
				'woo_order.financial_status',
				'woo_order.fecha_creacion',
			)
			->leftJoin('woo_order', 'iflow_woo_order_data.order_id', '=', 'woo_order.order_id')
			->get();
		*/
		...
		#dd($data);
		return view('admin.iflow_woo_order_data.index', ['data' => $data]);
	}
